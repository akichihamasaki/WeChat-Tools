'use strict';
angular.module('demo').controller('WeatherCtrl', ['$scope', 'yahooApi', 'geoApi', function($scope, yahooApi, geoApi) {
...
angular.module('demo').factory('yahooApi', ['$resource', function($resource) {
...
angular.module('demo').factory('geoApi', ['$http', function($http) {
