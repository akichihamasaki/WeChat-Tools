'use strict';
angular.module('demo').controller('MailCtrl', ['$scope', function($scope) {
  $scope.folds = [
    { name: 'Inbox', filter: '' },
...
angular.module('demo').controller('MailListCtrl', ['$scope', 'mails', '$stateParams', function($scope, mails, $stateParams) {
...
angular.module('demo').controller('MailDetailCtrl', ['$scope', 'mails', '$stateParams', function($scope, mails, $stateParams) {
  mails.get($stateParams.mailId).then(function(mail) {
    $scope.mail = mail;
  });
}]);

angular.module('demo').controller('MailNewCtrl', ['$scope', function($scope) {
  $scope.mail = {
    to: '',
    subject: '',
    content: ''
...
angular.module('demo').directive('labelColor', function() {
