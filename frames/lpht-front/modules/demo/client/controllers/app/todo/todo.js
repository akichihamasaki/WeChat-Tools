'use strict';
angular.module('demo').factory('todoStorage', function() {
...
angular.module('demo').controller('TodoCtrl', ['$scope', '$location', '$filter', 'todoStorage', function($scope, $location, $filter, todoStorage) {
