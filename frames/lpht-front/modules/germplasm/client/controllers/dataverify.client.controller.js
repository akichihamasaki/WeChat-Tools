 ...
 * @author zj
 */
angular.module('lpht.germplasm').controller('DataVerifyCtrl', ['$filter', '$scope', '$http', 'uiGridConstants', '$uibModal', 'ngDialog', 'toaster', function($filter, $scope, $http, uiGridConstants, $uibModal, ngDialog, toaster) {
...
/*审核模态弹出框controller*/
angular.module('lpht.germplasm').controller('VerifyModalCtrl', ['$scope', '$uibModalInstance', 'rowEntity', 'uiGridConstants', '$http', function($scope, $uibModalInstance, rowEntity, uiGridConstants, $http) {
  var cb = $scope.cb = {};
  cb.rowEntity = angular.copy(rowEntity);
  cb.ok = function() {
    $uibModalInstance.close();
  ...
  cb.addData = function() {
    var enteringNext = {
      breedName: cb.breedName1,
      growValue: cb.breedName1,
      growValue1: cb.breedName1,
      growValue2: cb.breedName1,
      tie: cb.breedName1,
      growAttribute: '',
      growAttribute1: '',
      growValue3: ''
